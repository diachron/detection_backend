...
public class SCDUtils {
     ...
     * among URIs.
     *
     * @param prop A properties file which denotes a) the
     * credentials for a JDBC Virtuoso connection and b) the folder which
    ...
    public void customCompareVersions(String oldV, String newV, String[] simpleChanges, String[] complexChanges) throws Exception {
        ...
        ChangesDetector detector = new ChangesDetector(propFile, ontology, tmpUri + "/changes/schema");
